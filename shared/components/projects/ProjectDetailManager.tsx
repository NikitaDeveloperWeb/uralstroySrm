...
export function ProjectDetailManager({ projectCost }: Props) {
  ...
  return (
    <div className="mt-8 p-6 bg-blue-50 rounded-lg border border-blue-200">
      <h2 className="text-xl font-bold text-gray-900 mb-4">Оплата менеджеру</h2>
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          <p className="text-sm text-gray-600 mb-1">Процент менеджера</p>
          <p className="text-lg font-semibold text-gray-900">{MANAGER_PERCENTAGE}%</p>
        </div>
        <div>
          <p className="text-sm text-gray-600 mb-1">Сумма менеджеру</p>
