  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Название фонда</label>
          <input
            type="text"
            value={formData.name}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Тип фонда</label>
        ...
        <div>
          ...
          <input
            ...
            placeholder="0"
          />
          <p className="text-xs text-gray-500 mt-1">Оставьте 0, если целевая сумма не установлена</p>
        </div>
