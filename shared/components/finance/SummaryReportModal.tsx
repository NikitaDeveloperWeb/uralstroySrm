        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {loading ? (
            ...
            <>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-slate-700"><span className="text-sm text-gray-600 dark:text-slate-300">Авансы</span><span className="text-sm font-medium text-red-600">-{report.advances.total.toLocaleString('ru-RU')} ₽</span></div>
                      ...
                      <div className="flex justify-between items-center py-2"><span className="text-sm text-gray-600 dark:text-slate-300">Общие расходы</span><span className="text-sm font-medium text-red-600">-{report.expenses.total.toLocaleString('ru-RU')} ₽</span></div>
                    </div>
                  </div>
              ...
              {activeTab === 'eot' && (
                <div className="space-y-3">
                  <div className="bg-blue-50 rounded-lg p-3 border border-blue-200 flex justify-between items-center"><span className="text-sm font-medium text-blue-800">Итого ЕОТ</span><span className="text-lg font-bold text-blue-900">{(report?.eot?.total ?? 0).toLocaleString('ru-RU')} ₽</span></div>
                  {(report?.eot?.reports?.length ?? 0) === 0 ? (<div className="text-center py-8 text-gray-500 dark:text-slate-400"><Briefcase className="w-12 h-12 mx-auto mb-2 text-gray-300 dark:text-slate-500" /><p className="text-sm">ЕОТ отчетов нет</p></div>) : (
